...
namespace Allors.Database.Server.Controllers
{
    ...
    public class TestPopulation
    {
        ...
        private void Full()
        {
            ...
            var noperm = this.transaction.Build<Person>(v =>
            {
                v.UserName = "noperm";
                v.FirstName = "no";
                v.LastName = "perm";
            ...
            C1 BuildC1(string name, int order) =>
                this.transaction.Build<C1>(v =>
                {
                    v.Name = name;
                    v.Order = order;
                });

            C2 BuildC2(string name, int order) =>
                this.transaction.Build<C2>(v =>
                {
                    v.Name = name;
                    v.Order = order;
                });

...
namespace Allors.Database.Domain.Tests
{
    ...
    public class MediaTest : ContentTests, IClassFixture<Fixture>
    {
        ...
        public void BuilderWithDataUrl()
        {
            ...
            var photo = this.Transaction.Build<Media>(v => v.InDataUri = DataUri);
        ...
        public void BuilderWithEmptyData()
        {
            ...
            var media = this.Transaction.Build<Media>(v => v.InData= binary);
        ...
        public void BuilderWithPng()
        {
            ...
            var media = this.Transaction.Build<Media>(v => v.InData = content);

// <copyright file="DelegateAccessTests.cs" company="Allors bv">
...
namespace Allors.Database.Domain.Tests
{
    ...
    public class DatabaseDelegatedAccessTests : DomainTest, IClassFixture<Fixture>
    {
        public DatabaseDelegatedAccessTests(Fixture fixture) : base(fixture) { }

...
";
            ...
            if (this.Config.SetupSecurity)
            {
                ...
                var databaseWrite = this.transaction.Extent<Permission>().First(v => v.Operation == Operations.Write && v.OperandType.Equals((OperandType)m.Denied.DatabaseProperty));
                var defaultWorkspaceWrite = this.transaction.Extent<Permission>().First(v => v.Operation == Operations.Write && v.OperandType.Equals((OperandType)m.Denied.DefaultWorkspaceProperty));
                var workspaceXWrite = this.transaction.Extent<Permission>().First(v => v.Operation == Operations.Write && v.OperandType.Equals((OperandType)m.Denied.WorkspaceXProperty));
            ...
            if (this.Config.SetupSecurity)
            {
                ...
                // Denied Permissions
                var fromTrimPermission = this.transaction.Extent<Permission>().First(v => v.Operation == Operations.Read && v.OperandType.Equals((OperandType)m.TrimFrom.Name));
                ...
                var toTrimPermission = this.transaction.Extent<Permission>().First(v => v.Operation == Operations.Read && v.OperandType.Equals((OperandType)m.TrimTo.Name));

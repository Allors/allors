namespace Allors.Embedded
{
    ...
    public class EmbeddedObject : IEmbeddedObject
    {
        ...
        public IUnitRole<T> GetUnitRole<T>(IEmbeddedRoleType roleType) => this.Population.GetUnitRole<T>(this, roleType);
        ...
        public ICompositeRole<T> GetCompositeRole<T>(IEmbeddedRoleType roleType) where T : IEmbeddedObject => this.Population.GetCompositeRole<T>(this, roleType);

...
namespace Allors.Workspace.Adapters.Direct
{
    ...
    {
        internal Strategy(Adapters.Workspace workspace, Class @class, long id) : base(workspace, @class, id) => this.DatabaseOriginState = new DatabaseOriginState(this, workspace.Connection.GetRecord(this.Id));

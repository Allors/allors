...
namespace Allors.Workspace.Adapters.Direct
{
    ...
    {
        internal Strategy(Adapters.Session session, Class @class, long id) : base(session, @class, id) => this.DatabaseOriginState = new DatabaseOriginState(this, session.Workspace.DatabaseConnection.GetRecord(this.Id));

...
namespace Allors.Workspace.Adapters
{
    ...
    {
        private readonly IDictionary<IRelationEndType, IDictionary<Strategy, object>> propertyByObjectByPropertyType;
        private IDictionary<IRelationEndType, IDictionary<Strategy, object>> changedPropertyByObjectByPropertyType;

        public PropertyByObjectByPropertyType()
        {
            this.propertyByObjectByPropertyType = new Dictionary<IRelationEndType, IDictionary<Strategy, object>>();
            this.changedPropertyByObjectByPropertyType = new Dictionary<IRelationEndType, IDictionary<Strategy, object>>();
        }

        public object GetUnit(Strategy @object, IRelationEndType propertyType) => this.Get(@object, propertyType);

        public void SetUnit(Strategy @object, IRelationEndType propertyType, object newValue) => this.Set(@object, propertyType, newValue);

        public Strategy GetComposite(Strategy @object, IRelationEndType propertyType) => (Strategy)this.Get(@object, propertyType);

        public void SetComposite(Strategy @object, IRelationEndType propertyType, Strategy newValue) => this.Set(@object, propertyType, newValue);

        public RefRange<Strategy> GetComposites(Strategy @object, IRelationEndType propertyType) => RefRange<Strategy>.Ensure(this.Get(@object, propertyType));

        public void SetComposites(Strategy @object, IRelationEndType propertyType, RefRange<Strategy> newValue) => this.Set(@object, propertyType, newValue);

        public void SetComposites(Strategy @object, IRelationEndType propertyType, object newValue)
        {
        ...
        public IDictionary<IRelationEndType, IDictionary<Strategy, object>> Checkpoint()
        {
            try
            {
        ...
        private object Get(Strategy @object, IRelationEndType propertyType)
        {
        ...
        private void Set(Strategy @object, IRelationEndType propertyType, object newValue)
        {
            if (!(this.propertyByObjectByPropertyType.TryGetValue(propertyType, out var valueByPropertyType) && valueByPropertyType.TryGetValue(@object, out var originalValue)))
            {
                originalValue = null;

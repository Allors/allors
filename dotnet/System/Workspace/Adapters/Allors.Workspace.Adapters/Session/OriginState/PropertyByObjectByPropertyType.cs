...
namespace Allors.Workspace.Adapters
{
    ...
    public class PropertyByObjectByPropertyType
    {
        ...
        public RefRange<Strategy> GetComposites(Strategy @object, IPropertyType propertyType) => RefRange<Strategy>.Load((IEnumerable<Strategy>)this.Get(@object, propertyType));
        ...
        public void SetComposites(Strategy @object, IPropertyType propertyType, object newValue)
        {
            ...
            if (propertyType.IsOne ? Equals(newValue, originalValue) : RefRange<Strategy>.Load((IEnumerable<Strategy>)newValue).Equals(originalValue))
            {

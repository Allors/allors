...
namespace Allors.Database.Data
{
    ...
    public class ContainedIn : IPropertyPredicate
    {
        ...
        private bool HasMissingArguments(IArguments arguments) => (this.Parameter != null && arguments?.HasArgument(this.Parameter) != true) || this.Extent?.HasMissingArguments(arguments) == true;

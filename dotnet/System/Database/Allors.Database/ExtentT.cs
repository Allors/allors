...
public class Extent<T> : IList, IList<T> where T : IObject // Extent<T> must also implement IList to be a DataSource during DataBinding.
{
    ...
    ///     <see cref="T:System.Collections.Generic.IList`1"></see> is read-only.
    /// </exception>
    ...
    ///     to the end of the destination array.-or-IObjectType T cannot be cast automatically to the type of the destination
    ///     array.
    /// </exception>

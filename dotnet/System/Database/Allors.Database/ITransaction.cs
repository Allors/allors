...
public interface ITransaction : IDisposable
{
    ...
    IFilter<T> Filter<T>(Action<ICompositePredicate> filter = null) where T : class, IObject;
    ...
    /// <returns>The extent.</returns>
    IFilter<IObject> Filter(Composite objectType, Action<ICompositePredicate> filter = null);

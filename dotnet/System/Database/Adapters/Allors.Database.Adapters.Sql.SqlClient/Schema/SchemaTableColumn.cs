// <copyright file="SchemaTableColumn.cs" company="Allors bv">
...
{
    public SchemaTableColumn(SchemaTable table, string name, string dataType, int? characterMaximumLength, int? numericPrecision,
        int? numericScale)
    {
        this.Table = table;
        this.Name = name;

...
public class Command : ICommand
{
    ...
    public void AddCompositeRoleParameter(long objectId) =>
        this.GetOrCreateParameter(this.mapping.ParamNameForCompositeRole, Mapping.SqlDbTypeForObject).Value = objectId;

    public void AddAssociationParameter(long objectId) =>
        this.GetOrCreateParameter(this.mapping.ParamNameForAssociation, Mapping.SqlDbTypeForObject).Value = objectId;
    ...
    public void AddCompositeRoleTableParameter(IEnumerable<CompositeRelation> relations) =>
        this.GetOrCreateTableParameter(this.mapping.ParamNameForTableType, this.mapping.TableTypeNameForCompositeRelation).Value =
            new CompositeRoleDataRecords(this.mapping, relations);

    public void AddCompositesRoleTableParameter(IEnumerable<long> objectIds) =>
        this.GetOrCreateTableParameter(this.mapping.ParamNameForTableType, this.mapping.TableTypeNameForObject).Value =
            new CompositesRoleDataRecords(this.mapping, objectIds);

...
internal sealed class ChangeSet : IChangeSet
{
    ...
    internal ChangeSet(ISet<IObject> created, ISet<IStrategy> deleted, IDictionary<IObject, ISet<IRoleType>> roleTypesByAssociation,
        IDictionary<IObject, ISet<IAssociationType>> associationTypesByRole)
    {

...
internal sealed class AssociationIntersectsEnumerable : Within
{
    private readonly AssociationType association;
    private readonly IEnumerable<IObject> enumerable;

    internal AssociationIntersectsEnumerable(IInternalExtentFiltered extent, AssociationType association, IEnumerable<IObject> enumerable)
    {

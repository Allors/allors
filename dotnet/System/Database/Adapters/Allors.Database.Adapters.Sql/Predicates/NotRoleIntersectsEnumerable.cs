...
internal sealed class NotRoleIntersectsEnumerable : Within
{
    private readonly IEnumerable<IObject> enumerable;
    private readonly RoleType role;

    internal NotRoleIntersectsEnumerable(IInternalExtentFiltered extent, RoleType role, IEnumerable<IObject> enumerable)
    {

...
internal sealed class RoleIntersectsEnumerable : Within
{
    private readonly IEnumerable<IObject> enumerable;
    private readonly RoleType role;

    internal RoleIntersectsEnumerable(IInternalExtentFiltered extent, RoleType role, IEnumerable<IObject> enumerable)
    {

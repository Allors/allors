...
public sealed class SqlPrefetchCompositeAssociationObjectTableEvent : Event
{
    public SqlPrefetchCompositeAssociationObjectTableEvent(ITransaction transaction) : base(transaction)
    {
    }

...
public sealed class SqlPrefetchCompositeRoleObjectTableEvent : Event
{
    public SqlPrefetchCompositeRoleObjectTableEvent(ITransaction transaction) : base(transaction)
    {
    }

...
public sealed class SqlPrefetchCompositeAssociationRelationTableEvent : Event
{
    public SqlPrefetchCompositeAssociationRelationTableEvent(ITransaction transaction) : base(transaction)
    {
    }

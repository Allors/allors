...
public sealed class SqlPrefetchCompositesRoleObjectTableEvent : Event
{
    public SqlPrefetchCompositesRoleObjectTableEvent(ITransaction transaction) : base(transaction)
    {
    }

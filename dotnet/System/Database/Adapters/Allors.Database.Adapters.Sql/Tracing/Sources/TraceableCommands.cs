// <copyright file="TraceableCommands.cs" company="Allors bv">
...
public sealed class TraceableCommands : Commands
{
    ...
    public TraceableCommands(Transaction transaction, IConnection connection) : base(transaction, connection) =>
    ...
    internal override void ClearCompositeAndCompositesRole(IList<long> associations, RoleType roleType)
    {
        ...
        {
            AssociationIds = associations?.ToArray(), RoleType = roleType,
        };
        this.sink.OnBefore(@event);

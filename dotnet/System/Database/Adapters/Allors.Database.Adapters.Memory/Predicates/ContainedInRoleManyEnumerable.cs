// <copyright file="RoleManyContainedInEnumerable.cs" company="Allors bv">
...
internal sealed class ContainedInRoleManyEnumerable : ContainedIn
{
    private readonly IEnumerable<IObject> containingEnumerable;
    private readonly RoleType roleType;

    internal ContainedInRoleManyEnumerable(ExtentFiltered extent, RoleType roleType, IEnumerable<IObject> containingEnumerable)
    {

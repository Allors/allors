        ...
        foreach (var init in this.Inits)
        {
            ...
            foreach (var mark in this.Markers)
            {
                for (var i = 0; i < numberOfRuns; i++)
                {
                    ...
                    Assert.Single(to.C1sWhereC1C2many2one);
                    Assert.Equal(from1, to.C1sWhereC1C2many2one.ElementAt(0));
                    Assert.Equal(from1, to.C1sWhereC1C2many2one.ElementAt(0));
        ...
        foreach (var init in this.Inits)
        {
            ...
            foreach (var mark in this.Markers)
            {
                for (var i = 0; i < numberOfRuns; i++)
                {
                    ...
                    Assert.Single(to.C3sWhereC3C4many2one);
                    Assert.Equal(from1, to.C3sWhereC3C4many2one.ElementAt(0));
                    Assert.Equal(from1, to.C3sWhereC3C4many2one.ElementAt(0));
        ...
        foreach (var init in this.Inits)
        {
            ...
            foreach (var mark in this.Markers)
            {
                for (var i = 0; i < numberOfRuns; i++)
                {
                    ...
                    Assert.Single(to.I1sWhereI1I12many2one);
                    Assert.Equal(from1, to.I1sWhereI1I12many2one.ElementAt(0));
                    Assert.Equal(from1, to.I1sWhereI1I12many2one.ElementAt(0));
    ...
    public void RelationChecks()
    {
        foreach (var init in this.Inits)
        {
            ...
            foreach (var mark in this.Markers)
            {
                ...
                {
                    mark();
                    c1a.Strategy.SetCompositeRole(m.C1.C1C2many2one, c1b);
                }
                catch
                {
                ...
                {
                    mark();
                    c1a.Strategy.SetCompositeRole(m.C1.C1I2many2one, c1b);
                }
                catch
                {
                    exceptionThrown = true;
                ...
                {
                    mark();
                    c1a.Strategy.SetCompositeRole(m.C1.C1S2many2one, c1b);
                }
                catch
                {
                    exceptionThrown = true;
                ...
                {
                    mark();
                    c1a.Strategy.SetCompositeRole(m.C2.C1many2one, c1b);
                }
                catch
                {
                    exceptionThrown = true;
                ...
                {
                    mark();
                    c1a.Strategy.SetCompositeRole(m.C2.C2C2many2one, c2b);
                }
                catch
                {
                    exceptionThrown = true;
                ...
                {
                    mark();
                    c1a.Strategy.SetCompositeRole(m.C1.C1C2many2manies, c2b);
                }
                catch
                {
                    exceptionThrown = true;

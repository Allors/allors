...
public abstract class ExtentTest : IDisposable
{
    ...
    [Fact]
    public void AssociationMany2ManyIntersects()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            foreach (var useEnumerable in TrueFalse)
            {
                foreach (var useOperator in this.UseOperator)
                {
                    ...
                    if (useEnumerable)
                    {
                        ...
                        extent.AddIntersects(m.C2.C1sWhereC1C2many2many, enumerable);
                    }
                    else
                    {
                        extent.AddIntersects(m.C2.C1sWhereC1C2many2many, inExtent);
                    }
                    ...
                    {
                        var enumerable = (IEnumerable<IObject>)inExtent;
                        extent.AddIntersects(m.I12.C1sWhereC1I12many2many, enumerable);
                    }
                    else
                    {
                        extent.AddIntersects(m.I12.C1sWhereC1I12many2many, inExtent);
                    }
                    ...
                    if (useEnumerable)
                    {
                        extent.AddIntersects(m.I34.I12sWhereI12I34many2many, (IExtent<IObject>)inExtent);
                    }
                    else
                    {
                        extent.AddIntersects(m.I34.I12sWhereI12I34many2many, inExtent);
                    }
                    ...
                    {
                        var enumerable = (IEnumerable<IObject>)inExtent;
                        extent.AddIntersects(m.I34.I12sWhereI12I34many2many, enumerable);
                    }
                    else
                    {
                        extent.AddIntersects(m.I34.I12sWhereI12I34many2many, inExtent);
    ...
    public void AssociationMany2ManyContains()
    {
        foreach (var init in this.Inits)
        {
            ...
            // Class
            var extent = this.Transaction.Filter(m.C2.Composite);
            extent.AddHas(m.C2.C1sWhereC1C2many2many, this.c1C);
            ...
            extent = this.Transaction.Filter(m.C2.Composite);
            extent.AddHas(m.C2.C1sWhereC1C2many2many, this.c1C);
            extent.AddHas(m.C2.C1sWhereC1C2many2many, this.c1D);
            ...
            // Interface
            extent = this.Transaction.Filter(m.I12.Composite);
            extent.AddHas(m.I12.C1sWhereC1I12many2many, this.c1C);
            ...
            // Super Interface
            extent = this.Transaction.Filter(m.S1234.Composite);
            extent.AddHas(m.S1234.S1234sWhereS1234many2many, this.c1B);
    ...
    public void AssociationMany2OneContains()
    {
        foreach (var init in this.Inits)
        {
            ...
            // Class
            var extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddHas(m.C1.C1sWhereC1C1many2one, this.c1C);
            ...
            extent = this.Transaction.Filter(m.C2.Composite);
            extent.AddHas(m.C2.C1sWhereC1C2many2one, this.c1C);
            ...
            extent.AddHas(m.C4.C3sWhereC3C4many2one, this.c3C);
            ...
            // Interface
            extent = this.Transaction.Filter(m.I12.Composite);
            extent.AddHas(m.I12.C1sWhereC1I12many2one, this.c1C);
    ...
    public void Naming()
    {
        foreach (var init in this.Inits)
        {
...

            {
                ...
                extent.AddHas(m.C1.C1C3one2manies, this.c3B);
    ...
    [Fact]
    public void NotAssociationMany2ManyIntersects()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            foreach (var useOperator in this.UseOperator)
            {
                ...
                var extent = this.Transaction.Filter(m.C2.Composite);
                extent.AddNot().AddIntersects(m.C2.C1sWhereC1C2many2many, inExtent);
                ...
                extent = this.Transaction.Filter(m.C2.Composite);
                extent.AddNot().AddIntersects(m.I12.C1sWhereC1I12many2many, inExtent);
    ...
    [Fact]
    public void NotRoleOne2ManyIntersects()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            foreach (var useOperator in this.UseOperator)
            {
                ...
                var extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddNot().AddIntersects(m.C1.C1C1one2manies, inExtent);
                ...
                extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddNot().AddIntersects(m.C1.C1C2one2manies, inExtent);
                ...
                extent.AddNot().AddIntersects(m.C3.C3C4one2manies, inExtent);
                ...
                extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddNot().AddIntersects(m.I12.I12C2one2manies, inExtent);
    ...
    public void NotRoleOne2ManyContains()
    {
        foreach (var init in this.Inits)
        {
            ...
            // Class
            var extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddNot().AddHas(m.C1.C1C2one2manies, this.c2C);
            ...
            // Interface
            extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddNot().AddHas(m.C1.C1I12one2manies, this.c2C);
            ...
            // Super Interface
            extent = this.Transaction.Filter(m.S1234.Composite);
            extent.AddNot().AddHas(m.S1234.S1234one2manies, this.c1B);
    ...
    [Fact]
    public void RoleMany2ManyIntersects()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            foreach (var useOperator in this.UseOperator)
            {
                ...
                var extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddIntersects(m.C1.C1C1many2manies, inExtent);
                ...
                extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddIntersects(m.C1.C1I12many2manies, inExtent);
    ...
    public void RoleMany2ManyContains()
    {
        foreach (var init in this.Inits)
        {
            ...
            // Class
            var extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddHas(m.C1.C1C2many2manies, this.c2C);
            ...
            extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddHas(m.C1.C1C2many2manies, this.c2B);
            extent.AddHas(m.C1.C1C2many2manies, this.c2C);
            ...
            // Interface
            extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddHas(m.C1.C1I12many2manies, this.c2C);
            ...
            // Super Interface
            extent = this.Transaction.Filter(m.S1234.Composite);
            extent.AddHas(m.S1234.S1234many2manies, this.c1A);
    ...
    [Fact]
    public void RoleOne2ManyIntersects()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            foreach (var useOperator in this.UseOperator)
            {
                ...
                var extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddIntersects(m.C1.C1C1one2manies, inExtent);
                ...
                extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddIntersects(m.C1.C1C2one2manies, inExtent);
                ...
                extent = this.Transaction.Filter(m.C3.Composite);
                extent.AddIntersects(m.C3.C3C4one2manies, inExtent);
                ...
                extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddIntersects(m.I12.I12C2one2manies, inExtent);
    ...
    public void RoleOne2ManyContains()
    {
        foreach (var init in this.Inits)
        {
            ...
            // Class
            var extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddHas(m.C1.C1C2one2manies, this.c2C);
            ...
            // Interface
            extent = this.Transaction.Filter(m.C1.Composite);
            extent.AddHas(m.C1.C1I12one2manies, this.c2C);
            ...
            // Super Interface
            extent = this.Transaction.Filter(m.S1234.Composite);
            extent.AddHas(m.S1234.S1234one2manies, this.c1B);
    ...
    [Fact]
    public void ValidateAssociationHas()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            {
                var extent = this.Transaction.Filter(m.C2.Composite);
                extent.AddHas(m.C2.C1WhereC1C2one2many, this.c1C);
            }
            catch (ArgumentException)
            {
                exceptionThrown = true;
            ...
            {
                var extent = this.Transaction.Filter(m.C2.Composite);
                extent.AddHas(m.C2.C1WhereC1C2one2one, this.c1C);
            }
            catch (ArgumentException)
            {
                exceptionThrown = true;
    ...
    [Fact]
    public void ValidateRoleHasFilter()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            {
                var extent = this.Transaction.Filter(m.C1.Composite);
                extent.AddHas(m.C1.C1AllorsString, this.c2C);
            }
            catch (ArgumentException)
            {
                exceptionThrown = true;
    ...
    [Fact]
    public void RoleHasMany2ManyAndContained()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            c2s.AddHas(m.C2.C3Many2Manies, c3);
    ...
    [Fact]
    public void RoleHasOne2ManySharedClassAndContained()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            c3s.AddHas(m.C3.C3C4one2manies, c4);
    ...
    [Fact]
    public void AssociationHasMany2ManyAndContained()
    {
        foreach (var init in this.Inits)
        {
            init();
            ...
            var c2s = this.Transaction.Filter(m.C2.Composite);
            c2s.AddHas(m.C2.C3sWhereC3C2many2many, c3);

...
public class Command : ICommand
{
    ...
    public void AddCompositeRoleParameter(long objectId) =>
        this.GetOrCreateParameter(this.mapping.ParamInvocationNameForCompositeRole, Mapping.NpgsqlDbTypeForObject).Value = objectId;

    public void AddAssociationParameter(long objectId) =>
        this.GetOrCreateParameter(this.mapping.ParamInvocationNameForAssociation, Mapping.NpgsqlDbTypeForObject).Value = objectId;
    ...
    public void UnitTableParameter(RoleType roleType, IEnumerable<UnitRelation> relations)
    {
        ...
        var roleParameter =
            this.GetOrCreateTableParameter(this.mapping.StringRoleArrayParam.InvocationName, this.mapping.GetNpgsqlDbType(roleType));

// <copyright file="Connection.cs" company="Allors bv">
...
public class Connection : IConnection
{
    ...
    public ICommand CreateCommand()
    {
        if (this.NpgsqlConnection == null)
        {
            ...
            this.NpgsqlTransaction =
                this.NpgsqlConnection.BeginTransaction(this.Database.IsolationLevel ?? Sql.Database.DefaultIsolationLevel);
        }
    ...
    private Command CreateCommand(Mapping mapping, NpgsqlCommand sqlCommand) => new(mapping, sqlCommand);
}

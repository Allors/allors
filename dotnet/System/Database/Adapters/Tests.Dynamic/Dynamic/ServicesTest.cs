                ...
                for (var iAssertRepeat = 0; iAssertRepeat < this.GetAssertRepeats().Length; iAssertRepeat++)
                {
                    for (var transactionFlagIndex = 0; transactionFlagIndex < this.GetBooleanFlags().Length; transactionFlagIndex++)
                    {
                        ...
                        for (var iTestType = 0; iTestType < this.GetTestTypes().Length; iTestType++)
                        {
                            ...
                            {
                                var allorsObjects = this.GetTransaction().Build(testType, objectCount);
            ...
            for (var iTestRepeat = 0; iTestRepeat < this.GetTestRepeats().Length; iTestRepeat++)
            {
                for (var iAssertRepeat = 0; iAssertRepeat < this.GetAssertRepeats().Length; iAssertRepeat++)
                {
                    for (var transactionFlagIndex = 0; transactionFlagIndex < this.GetBooleanFlags().Length; transactionFlagIndex++)
                    {
                        ...
                        for (var secondTransactionFlagIndex = 0;
                             secondTransactionFlagIndex < this.GetBooleanFlags().Length;
                             secondTransactionFlagIndex++)
                        {
                            var secondTransactionFlag = this.GetBooleanFlags()[secondTransactionFlagIndex];
                            for (var thirdTransactionFlagIndex = 0;
                                 thirdTransactionFlagIndex < this.GetBooleanFlags().Length;
                                 thirdTransactionFlagIndex++)
                            {
                                var thirdTransactionFlag = this.GetBooleanFlags()[thirdTransactionFlagIndex];

                                for (var fourthTransactionFlagIndex = 0;
                                     fourthTransactionFlagIndex < this.GetBooleanFlags().Length;
                                     fourthTransactionFlagIndex++)
                                {
                                    var fourthTransactionFlag = this.GetBooleanFlags()[fourthTransactionFlagIndex];

                                    for (var useRollbackFlagIndex = 0;
                                         useRollbackFlagIndex < this.GetBooleanFlags().Length;
                                         useRollbackFlagIndex++)
                                    {
                                        ...
                                        for (var iTestType = 0; iTestType < this.GetTestTypes().Length; iTestType++)
                                        {
                                            ...
                                            allorsObject = this.GetTransaction().Build(testType);
                                            var id = allorsObject.Strategy.ObjectId.ToString();
                                            this.Commit(secondTransactionFlag);
                                            allorsObject.Strategy.Delete();
                                            this.Commit(thirdTransactionFlag);
                                            ...
                                            var proxy = this.GetTransaction().Build(testType);
                                            id = proxy.Strategy.ObjectId.ToString();
                                            this.Commit(secondTransactionFlag);
                                            var subject = this.GetTransaction().Instantiate(id);
                                            ...
                                            for (var testRoleTypeIndex = 0; testRoleTypeIndex < testRoleTypes.Count(); testRoleTypeIndex++)
                                            {
                                                ...
                                                for (var useCachingFlagIndex = 0;
                                                     useCachingFlagIndex < this.GetBooleanFlags().Length;
                                                     useCachingFlagIndex++)
                                                {
                                                    var useCachingFlag = this.GetBooleanFlags()[useCachingFlagIndex];
                                        ...
                                        for (var relationIndex = 0; relationIndex < relationTypes.Count(); relationIndex++)
                                        {
                                            ...
                                            for (var useRoleCachingFlagIndex = 0;
                                                 useRoleCachingFlagIndex < this.GetBooleanFlags().Length;
                                                 useRoleCachingFlagIndex++)
                                            {
                                                var useRoleCachingFlag = this.GetBooleanFlags()[useRoleCachingFlagIndex];
                                                for (var useAssociationCachingFlagIndex = 0;
                                                     useAssociationCachingFlagIndex < this.GetBooleanFlags().Length;
                                                     useAssociationCachingFlagIndex++)
                                                {
                                                    var useAssociationCachingFlag = this.GetBooleanFlags()[useAssociationCachingFlagIndex];
                                                         ...
                                                         iAssociationType++)
                                                    {
                                                        ...
                                                        for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                                        {
                                                            ...
                                                            // delete role
                                                            association = this.GetTransaction().Build(associationType);
                                                            role = this.GetTransaction().Build(roleType);
                                                     ...
                                                     useAssociationCachingFlagIndex++)
                                                {
                                                         ...
                                                         iAssociationType++)
                                                    {
                                                        ...
                                                        for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                                        {
                                                            ...
                                                            // AssociationType
                                                            var associations = this.CreateArray(relationType.AssociationType.ObjectType, 3);
                                                            associations[0] = this.GetTransaction().Build(associationType);
                                                            associations[1] = this.GetTransaction().Build(associationType);
                                                            associations[2] = this.GetTransaction().Build(associationType);
                                                            var roles = this.CreateArray(relationType.RoleType.ObjectType, 2);
                                                            roles[0] = this.GetTransaction().Build(roleType);

                                                            roles[1] = this.GetTransaction().Build(roleType);
                                                            ...
                                                            {
                                                                roles[0].Strategy
                                                                    .GetCompositesAssociation<IObject>(relationType.AssociationType)
                                                                    .ToArray();
                                                                roles[1].Strategy
                                                                    .GetCompositesAssociation<IObject>(relationType.AssociationType)
                                                                    .ToArray();
                                                            ...
                                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                            {
                                                                ...
                                                                Assert.Empty((IObject[])roles[0].Strategy
                                                                    .GetCompositesAssociation<IObject>(relationType.AssociationType));
                                                                Assert.Single((IObject[])roles[1].Strategy
                                                                    .GetCompositesAssociation<IObject>(relationType.AssociationType));
                                                                Assert.Equal(associations[2],
                                                                    ((IObject[])roles[1].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType
                                                                            .AssociationType))[0]);
                                                            ...
                                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                            {
                                                                ...
                                                                Assert.Equal(2,
                                                                    ((IObject[])roles[1].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType.AssociationType))
                                                                    .Count());
                                                                Assert.Contains(associations[1],
                                                                    (IObject[])roles[1].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType.AssociationType));
                                                                Assert.Contains(associations[2],
                                                                    (IObject[])roles[1].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType.AssociationType));
                                                     ...
                                                     useAssociationCachingFlagIndex++)
                                                {
                                                         ...
                                                         iAssociationType++)
                                                    {
                                                        ...
                                                        for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                                        {
                                                            ...
                                                            // AssociationType
                                                            var associations = this.CreateArray(relationType.AssociationType.ObjectType, 2);
                                                            associations[0] = this.GetTransaction().Build(associationType);
                                                            associations[1] = this.GetTransaction().Build(associationType);
                                                            var roles = this.CreateArray(relationType.RoleType.ObjectType, 3);
                                                            roles[0] = this.GetTransaction().Build(roleType);

                                                            roles[1] = this.GetTransaction().Build(roleType);

                                                            roles[2] = this.GetTransaction().Build(roleType);

                                                            if (useRoleCachingFlag)
                                                            {
                                                                associations[0].Strategy.GetCompositesRole<IObject>(relationType.RoleType)
                                                                    .ToArray();
                                                                associations[1].Strategy.GetCompositesRole<IObject>(relationType.RoleType)
                                                                    .ToArray();
                                                            }
                                                            ...
                                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                            {
                                                                ...
                                                                try
                                                                {
                                                                    associations[0].Strategy
                                                                        .GetCompositesRole<IObject>(relationType.RoleType).ToArray();
                                                                }
                                                                catch
                                                                {
                                                                    exceptionThrown = true;
                                                                ...
                                                                var association1Roles = associations[1].Strategy
                                                                    .GetCompositesRole<IObject>(relationType.RoleType).ToArray();
                                                                ...
                                                                Assert.Null(roles[0].Strategy
                                                                    .GetCompositeAssociation(relationType.AssociationType));
                                                                Assert.Null(roles[1].Strategy
                                                                    .GetCompositeAssociation(relationType.AssociationType));
                                                                Assert.Equal(associations[1],
                                                                    roles[2].Strategy
                                                                        .GetCompositeAssociation(relationType.AssociationType));
                                                            ...
                                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                            {
                                                                var association0Roles = associations[0].Strategy
                                                                    .GetCompositesRole<IObject>(relationType.RoleType).ToArray();
                                                                ...
                                                                Assert.Empty((IObject[])associations[1].Strategy
                                                                    .GetCompositesRole<IObject>(relationType.RoleType));
                                                                var exceptionThrown = false;
                                                                try
                                                                {
                                                                    roles[2].Strategy.GetCompositeAssociation(relationType.AssociationType);
                                                            ...
                                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                            {
                                                                ...
                                                                Assert.Equal(associations[1],
                                                                    ((IObject[])roles[1].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType
                                                                            .AssociationType))[0]);
                                                                Assert.Single((IObject[])roles[2].Strategy
                                                                    .GetCompositesAssociation<IObject>(relationType.AssociationType));
                                                                Assert.Equal(associations[1],
                                                                    ((IObject[])roles[2].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType
                                                                            .AssociationType))[0]);
                                                            ...
                                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                            {
                                                                ...
                                                                Assert.Equal(2,
                                                                    ((IObject[])roles[1].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType.AssociationType))
                                                                    .Count());
                                                                Assert.Contains(associations[0],
                                                                    (IObject[])roles[1].Strategy
                                                                        .GetCompositesAssociation<IObject>(relationType.AssociationType));
                                                                Assert.Contains(associations[1],
                                                                    (IObject[])roles[1].Strategy
                    ...
                    for (var iAssertRepeat = 0; iAssertRepeat < this.GetAssertRepeats().Length; iAssertRepeat++)
                    {
                        for (var iTestType = 0; iTestType < this.GetTestTypes().Length; iTestType++)
                        {
                            ...
                            for (var useRollbackFlagIndex = 0; useRollbackFlagIndex < this.GetBooleanFlags().Length; useRollbackFlagIndex++)
                            {
                                ...
                                for (var transactionFlagIndex = 0;
                                     transactionFlagIndex < this.GetBooleanFlags().Length;
                                     transactionFlagIndex++)
                                {
                                    var transactionFlag = this.GetBooleanFlags()[transactionFlagIndex];
                                                 ...
                                                 useAssociationCachingFlagIndex++)
                                            {
                                                     ...
                                                     iAssociationType++)
                                                {
                                                    ...
                                                    for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                                    {
                                                        ...
                                                        {
                                                            roles[0].Strategy
                                                                .GetCompositesAssociation<IObject>(relationType.AssociationType).ToArray();
                                                            roles[1].Strategy
                                                                .GetCompositesAssociation<IObject>(relationType.AssociationType).ToArray();
                                                        }
                                                        ...
                                                        for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                        {
                                                            ...
                                                            Assert.Single((IObject[])roles[0].Strategy
                                                                .GetCompositesAssociation<IObject>(relationType.AssociationType));
                                                            Assert.Equal(associations[0],
                                                                ((IObject[])roles[0].Strategy
                                                                    .GetCompositesAssociation<IObject>(relationType.AssociationType))[0]);
                                                            Assert.Equal(2,
                                                                ((IObject[])roles[1].Strategy
                                                                    .GetCompositesAssociation<IObject>(relationType.AssociationType))
                                                                .Count());
                                                     ...
                                                     iAssociationType++)
                                                {
                                                    ...
                                                    for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                                    {
                                                        ...
                                                        for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                                        {
                                                            ...
                                                            var role2Associations = roles[2].Strategy
                                                                .GetCompositesAssociation<IObject>(relationType.AssociationType).ToArray();
                                     ...
                                     fourthTransactionFlagIndex++)
                                {
                                         ...
                                         useRollbackFlagIndex++)
                                    {
                                        ...
                                        for (var iTestType = 0; iTestType < this.GetTestTypes().Length; iTestType++)
                                        {
                                            ...
                                            var anObject = this.GetTransaction().Build(testType);
                                            var anId = anObject.Strategy.ObjectId.ToString();
                                            var aProxy = this.GetTransaction().Instantiate(anId);

                                            var anotherObject = this.GetTransaction().Build(testType);
                                            ...
                                            anObject = this.GetTransaction().Build(testType);
                                            anId = anObject.Strategy.ObjectId.ToString();

                                            anotherObject = this.GetTransaction().Build(testType);
        ...
        for (var iRepeat = 0; iRepeat < this.GetRepeats().Length; iRepeat++)
        {
            ...
            for (var iTestRepeat = 0; iTestRepeat < this.GetTestRepeats().Length; iTestRepeat++)
            {
                ...
                for (var iAssertRepeat = 0; iAssertRepeat < this.GetAssertRepeats().Length; iAssertRepeat++)
                {
                    ...
                    {
                        var manyFlag = this.manyFlags[iManyFlag];
                        ...
                        for (var transactionFlagIndex = 0; transactionFlagIndex < this.GetBooleanFlags().Length; transactionFlagIndex++)
                        {
                            ...
                            for (var iTestType = 0; iTestType < this.GetTestTypes().Length; iTestType++)
                            {
                                var testType = this.GetTestTypes()[iTestType];
                                {
                                    ...
                                    for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                    {
                                        var unexistingObject = this.Instantiate(int.MaxValue - 1, manyFlag);
...

                                {
                                    ...
                                    var sameObject = this.Instantiate(id, manyFlag);
...

                                {
                                    ...
                                    var subject = this.GetTransaction().Build(testType);
                                    var id = int.Parse(subject.Strategy.ObjectId.ToString());
                                    var testRoleTypes = this.GetStringRoles(testType);

                                    var valueA = this.ValueGenerator.GenerateString(100);
                                    var valueB = this.ValueGenerator.GenerateString(100);
                                    var valueC = this.ValueGenerator.GenerateString(100);
                                    var valueD = this.ValueGenerator.GenerateString(100);
                                         ...
                                         testRoleTypeIndex++)
                                    {
                                        ...
                                        var proxy = this.Instantiate(id, manyFlag);
                                        ...
                                        for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                        {
                                            ...
                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                            {
                                                     ...
                                                     testRepeatIndex++)
                                                {
                                                    ...
                                                    Assert.Equal(associationProxy,
                                                        role.Strategy.GetCompositeAssociation(relationType.AssociationType));
                                                    Assert.Equal(role, associationProxy.Strategy.GetRole(relationType.RoleType));
                                                    Assert.Equal(association,
                                                        roleProxy.Strategy.GetCompositeAssociation(relationType.AssociationType));
                                                    this.Commit(transactionFlag);
                                                }
                                        ...
                                        for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                        {
                                            ...
                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                            {
                                                ...
                                                for (var testRepeatIndex = 0;
                                                     ...
                                                     testRepeatIndex++)
                                                {
                                                    Assert.Equal(roleProxy,
                                                        ((IObject[])association.Strategy.GetCompositesRole<IObject>(relationType.RoleType))[
                                                            0]);
                                                    Assert.Equal(associationProxy,
                                                        role.Strategy.GetCompositeAssociation(relationType.AssociationType));
                                                    Assert.Equal(role,
                                                        ((IObject[])associationProxy.Strategy.GetCompositesRole<IObject>(relationType
                                                            .RoleType))[0]);
                                                    Assert.Equal(association,
                                                        roleProxy.Strategy.GetCompositeAssociation(relationType.AssociationType));
                                                    this.Commit(transactionFlag);
                                        ...
                                        for (var iRoleType = 0; iRoleType < roleTypes.Count(); iRoleType++)
                                        {
                                            ...
                                            for (var repeatIndex = 0; repeatIndex < repeat; repeatIndex++)
                                            {
                                                     ...
                                                     testRepeatIndex++)
                                                {
                                                    Assert.Equal(roleProxy, association.Strategy.GetRole(relationType.RoleType));
                                                    Assert.Equal(associationProxy,
                                                        ((IObject[])role.Strategy.GetCompositesAssociation<IObject>(relationType
                                                            .AssociationType))[0]);
                                                    Assert.Equal(role, associationProxy.Strategy.GetRole(relationType.RoleType));
                                                    Assert.Equal(association,
                                                        ((IObject[])roleProxy.Strategy.GetCompositesAssociation<IObject>(relationType
                                                            .AssociationType))[0]);
                                                    this.Commit(transactionFlag);
                                                }
                                                ...
                                                {
                                                    Assert.Null(association.Strategy.GetRole(relationType.RoleType));
                                                    Assert.Empty((IObject[])role.Strategy.GetCompositesAssociation<IObject>(relationType
                                                        .AssociationType));
                                                    Assert.Null(associationProxy.Strategy.GetRole(relationType.RoleType));
                                                    Assert.Empty((IObject[])roleProxy.Strategy.GetCompositesAssociation<IObject>(
